...
int i=con.createStatement().executeUpdate("insert into coachings values (null,'"+nm1+"','"+nm2+"','"+nm3+"','"+nm4+"') ");
if(i>0)
    {
 response.sendRedirect("coachings.jsp?msg=Record Inserted");
 }
else
    {
response.sendRedirect("coachings.jsp?msg=Record Not Inserted");
}
}catch(Exception e)
        {
out.println(e);
