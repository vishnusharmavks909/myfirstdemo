...
int i=con.createStatement().executeUpdate("insert into college values (null,'"+nm1+"','"+nm2+"','"+nm3+"','"+nm4+"') ");
if(i>0)
    {
 response.sendRedirect("college.jsp?msg=Record Inserted");
 }
else
    {
response.sendRedirect("college.jsp?msg=Record Not Inserted");
}
}catch(Exception e)
        {
out.println(e);
